...
/// 手势HID模式枚举
typedef SWIFT_ENUM(uint8_t, BCLGestureHIDMode, closed) {
/// 刷视频模式
...
/// OTA类型
typedef SWIFT_ENUM(uint8_t, BCLOTAType, closed) {
/// 未知
  BCLOTATypeUnknown = 0,
/// 阿波罗
  BCLOTATypeApollo = 1,
...
/// 时区枚举
typedef SWIFT_ENUM(NSInteger, BCLRingTimeZone, closed) {
/// 中时区
...
typedef SWIFT_ENUM(uint8_t, BCLTouchHIDMode, closed) {
/// 刷视频模式
