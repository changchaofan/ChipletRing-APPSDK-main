//
//  GoMorePKeyRequestConfig_Dialog.swift
//  BCLRingSDKDemo
//
//  Created by Codex on 2025/12/20.
//  GoMore PKey请求参数配置对话框
//
...
class GoMorePKeyRequestConfig_Dialog: UIView {
    var confirmButtonCallback: ((_ deviceId: String, _ apiKey: String) -> Void)?

    private let defaultApiKey = "76d07e37bfe341b1a25c76c0e25f457a"
    ...
    private func setupConstraints() {
        ...
        cancelButton.snp.makeConstraints { make in
            make.top.equalTo(apiKeyTextField.snp.bottom).offset(24)
            make.left.equalToSuperview().offset(20)
    ...
    private func setupDefaultValues() {
        apiKeyTextField.text = defaultApiKey
    }
    ...
    private lazy var apiKeyTextField: QMUITextField = {
        let textField = QMUITextField()
    ...
    @objc private func confirmButtonTapped() {
        ...
        BDLogger.info("请求GoMore PKey参数 - deviceId: \(deviceId), apiKey: \(apiKey)")
        confirmButtonCallback?(deviceId, apiKey)
