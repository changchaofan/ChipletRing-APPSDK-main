//
//  BloodOxygenConfig_Dialog.swift
//  BCLRingSDKDemo
//
...
class BloodOxygenConfig_Dialog: UIView {
    var confirmButtonCallback: ((_ collectTime: Int, _ collectFrequency: Int, _ waveformConfig: Int, _ progressConfig: Int) -> Void)?
    ...
    @objc func confirmButtonTapped() {
        ...
        BDLogger.info("血氧测量配置 - 采集时间:\(collectTime), 采集频率:\(collectFrequency), 波形配置:\(waveformConfig), 进度配置:\(progressConfig)")
        confirmButtonCallback?(collectTime, collectFrequency, waveformConfig, progressConfig)
