//
//  FirmwareVersionConfig_Dialog.swift
//  BCLRingSDKDemo
//
...
class FirmwareVersionConfig_Dialog: UIView {
    ...
    lazy var confirmButton: UIButton = {
        let button = UIButton()
        button.setTitle("检查更新", for: .normal)
        button.setTitleColor(.white, for: .normal)
    ...
    @objc func confirmButtonTapped() {
        ...
        BDLogger.info("固件版本检查 - 版本号:\(version)")
